...
fn decode_cb_instruction(parameter: u8) -> Result<DecodedInstruction, ()> {
    ...
    match parameter {
        ...
        x if x & 0b1100_0000 == 0x40 => {
            ...
            match register {
                0 => Ok(DI {
                    ins: BIT { src: R8(B), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                1 => Ok(DI {
                    ins: BIT { src: R8(C), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                2 => Ok(DI {
                    ins: BIT { src: R8(D), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                3 => Ok(DI {
                    ins: BIT { src: R8(E), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                4 => Ok(DI {
                    ins: BIT { src: R8(H), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                5 => Ok(DI {
                    ins: BIT { src: R8(L), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
        ...
        x if x & 0b1100_0000 == 0xC0 => {
            ...
            match register {
                0 => Ok(DI {
                    ins: SET { dest: R8(B), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                1 => Ok(DI {
                    ins: SET { dest: R8(C), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                2 => Ok(DI {
                    ins: SET { dest: R8(D), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                3 => Ok(DI {
                    ins: SET { dest: R8(E), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                4 => Ok(DI {
                    ins: SET { dest: R8(H), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                5 => Ok(DI {
                    ins: SET { dest: R8(L), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
        ...
        x if x & 0b1100_0000 == 0x80 => {
            ...
            match register {
                0 => Ok(DI {
                    ins: RES { dest: R8(B), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                1 => Ok(DI {
                    ins: RES { dest: R8(C), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                2 => Ok(DI {
                    ins: RES { dest: R8(D), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                3 => Ok(DI {
                    ins: RES { dest: R8(E), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                4 => Ok(DI {
                    ins: RES { dest: R8(H), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
                5 => Ok(DI {
                    ins: RES { dest: R8(L), bit },
                    cycles: 8,
                    advance: 2,
                    flags: None,
                }),
